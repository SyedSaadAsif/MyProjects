...
void myRect(int x1, int y1, int x2, int y2, int R=0, int G=0, int B=0, int fillR = 0, int fillG = 0, int fillB = 0)
{
	HWND console_handle = GetConsoleWindow();
	HDC device_context = GetDC(console_handle);
...
void myTriangle(int x1, int y1, int x2, int y2, int x3, int y3, int R, int G, int B, int fillR = 0, int fillG = 0, int fillB = 0)
{
	...
	POINT points[3]; // Create an array to hold the triangle's points
